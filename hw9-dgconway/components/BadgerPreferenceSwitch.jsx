...
function BadgerPreferenceSwitch(props) {
  ...
  // the first time the component loads, set the property to true
  // because onload, the above useEffect gets called which swaps the
  // state isOn
  useEffect(() => props.handleToggle(props.prefName, isOn), []);
